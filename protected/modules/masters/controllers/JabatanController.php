...
class JabatanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','listjabatan'),
				'users'=>array('*'),
			),
	...
	public function actionListjabatan(){
		$data = Jabatan::model()->findAll('unitkerja_id=:ukid', 
		array(':ukid'=>(int) $_POST['unitkerja_id']));
		
		$data=CHtml::listData($data,'id','jabatan_name');
